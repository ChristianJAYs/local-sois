        ...
        @method('PUT')
            <div class="px-6 py-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="type" name="type" placeholder= "{{$selectPageType->page_type}}" class="form-control" >
                </div>
                <div class="form-group">
                    <label for="asset_type_description">Page Type Description : </label>
                    <input type="text" id="asset_type_description" name="asset_type_description" placeholder="{{$selectPageType->page_description}}" class="form-control" >
                </div>
                @endforeach
            </div>
